      ...
      <div className="relative w-full max-w-md bg-white rounded-[32px] shadow-2xl overflow-hidden animate-fade-in-up">
        ...
        <div className="p-8">
          ...
          <div className="flex flex-col items-center mb-6">
            <div className="w-16 h-16 bg-gradient-to-br from-primary-container to-pink-200 rounded-full flex items-center justify-center mb-3 shadow-[0_8px_20px_-5px_rgba(134,78,90,0.3)] overflow-hidden">
              <img src="/premium_logo.png" alt="Frosty Fluffs" className="w-full h-full object-cover rounded-full" />
            </div>
