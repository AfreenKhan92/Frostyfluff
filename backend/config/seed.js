...
const sampleProducts = [
  ...
  { name: 'Red Velvet Bliss', price: 48.00, category: 'cakes', image: '', description: 'Soft red velvet layers with tangy cream cheese frosting and white chocolate shavings.', tags: ['premium'] },
  { name: 'Lemon Drizzle Cake', price: 38.00, category: 'cakes', image: '', description: 'Light and zesty lemon sponge with a sweet citrus glaze.', tags: [] },
  { name: 'Pain au Chocolat', price: 4.50, category: 'pastries', image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuClQlcdsT7_CE6P2z3_MB5yO413r0py6HfT49lnpIqddw3Cd7rE8pV8rRdAWGVvZXkqgwyjNhKBWzfrXW-eE_byA5zxyv9AYxm9nO2kJvLZllUsjuZB-QuC2LH3ndFjDETpSK4jNB7IfwYQJ9cBj_eLHDyt4LNKDtgQlHi0rVtYkC1vaSKoo8FDMq0RqRdl-EW5m3y1_Cbc3cDbd4yoe498EWSihs1Gb9Qly9F9kaA1CkvNhhRoVyPlwUMP0otcwvxhh451BqwhhQRe', description: 'Flaky, buttery pastry filled with rich dark chocolate.', tags: ['popular'] },
  ...
  { name: 'Sugar Cookie Stars (12 pcs)', price: 12.00, category: 'cookies', image: '', description: 'Star-shaped sugar cookies with colorful royal icing.', tags: ['seasonal'] },
  { name: 'Matcha White Choc Cookies (6 pcs)', price: 10.00, category: 'cookies', image: '', description: 'Soft-baked matcha cookies studded with premium white chocolate chips.', tags: [] },
  ...
  { name: 'Brioche Loaf', price: 7.50, category: 'breads', image: '', description: 'Soft, buttery brioche with a golden crust.', tags: [] },
  ...
  { name: 'Rose Hot Chocolate', price: 5.50, category: 'beverages', image: '', description: 'Velvety hot chocolate infused with rose syrup and topped with whipped cream.', tags: ['seasonal'] },
];
